...
## The AI workflow toolkit for privacy-focused teams
...
Budibase is the open-source open-source AI workflow toolkit for privacy-focused teams.
...
We've recently launched Budibase Agents, which allow you to configure intelligent assistants by connecting existing tools and data to any LLM with an OpenAI-compatible API, including open-source and locally hosted models.
