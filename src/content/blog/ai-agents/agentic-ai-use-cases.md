...
Budibase is the all-in-one open-source AI workflow toolkit that connects to any data, API, or LLM.

We offer extensive support for a huge range of LLMs, RDBMSs, NoSQL tools, APIs, and more, alongside AI agents, autogenerated UIs, a visual automation builder, optional self-hosting, free SSO, and custom RBAC.
