...
Budibase is the open-source AI toolkit workflow toolkit for privacy-first teams. We offer connectivity for a huge range of LLMs, RDBMSs, NoSQL tools, APIs, and more, alongside AI agents, autogenerated UIs, visual automations, free SSO, optional self-hosting, and more.
