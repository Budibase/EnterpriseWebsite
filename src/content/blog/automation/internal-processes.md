...
Often, these replace generic tools like spreadsheets - or even email chains. Check out our in-depth guide on [internal tools](https://budibase.com/product/apps/) to learn more.
...
Or, we might use dashboards and [admin panels](https://budibase.com/product/apps/) to help users access data that they need to make decisions within a particular process.
...
Check out our guide to [approval apps](https://budibase.com/product/apps/) to learn more.
