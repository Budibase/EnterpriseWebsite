...
Budibase is the open-source AI workflow toolkit for privacy first teams to build agents, apps, and automations. 

With connectivity for a huge range of LLMs, RDBMSs, NoSQL tools, and APIs, alongside AI agents, autogenerated UIs, a powerful visual automation builder, optional self-hosting, and free SSO, there’s never been an better way to output secure, AI-power internal tools.
